...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            google_redirect_uri = "https://homabaysouq.onrender.com/accounts/google/callback/"
        ...
        try:
            ...
            # Direct hardcoded redirect URI (matching what's in adapters.py)
            facebook_redirect_uri = "https://homabaysouq.onrender.com/accounts/facebook/callback/"
        ...
        self.stdout.write(f"✅ Google callback in views: https://homabaysouq.onrender.com/accounts/google/callback/")
        self.stdout.write(f"✅ Facebook callback in views: https://homabaysouq.onrender.com/accounts/facebook/callback/")
