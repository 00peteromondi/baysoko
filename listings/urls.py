...
urlpatterns = [
    ...
    path('listing/<int:pk>/videos/add/', views.add_listing_video, name='add_listing_video'),
    path('listing/<int:pk>/videos/<int:video_id>/delete/', views.delete_listing_video, name='delete_listing_video'),
    path('listing/<int:pk>/campaign/enroll/', views.enroll_listing_campaign, name='enroll_listing_campaign'),
    path('listing/<int:pk>/campaign/withdraw/', views.withdraw_listing_campaign, name='withdraw_listing_campaign'),
    ...
    path('cart/increment/<int:listing_id>/', views.cart_increment_quantity, name='cart_increment'),
    path('cart/decrement/<int:listing_id>/', views.cart_decrement_quantity, name='cart_decrement'),
