...
class ListingCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        # Track if this is a new listing (for correct success message)
        is_new_listing = not form.instance.pk
        ...
        if videos:
            ...
            if existing_count + len(videos) > 3:
                form.add_error('video_descriptions', "You can upload up to 3 video descriptions per listing.")
...
class ListingUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        # Track if this is updating an existing listing (should always be true in UpdateView)
        is_new_listing = not self.object.pk
